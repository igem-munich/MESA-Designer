...
from util.database_interaction import create_databse, read_csv, create_table_from_header, insert_data
...
if  __name__ == "__main__":
    ...
    conn: sqlite3.Connection = create_databse("./data/sabdab_summary_all.sqlite")
